...
**Forthcoming.** The camera-ready paper is not in the official proceedings yet. We will add a BibTeX snippet here **after CVPR/CVPRW 2026 publication**, so citations match the IEEE/CVF entry.
